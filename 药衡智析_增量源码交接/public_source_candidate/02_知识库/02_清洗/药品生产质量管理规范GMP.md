...
X
药品生产质量管理规范(2010 年修订)
(2011 年 1 月 17 日卫生部令第 79 号公布 自 2011 年 3 月 1 日起施行)
第一章 总 则
...
X
2.承担产品放行的职责,确保每批已放行产品的生产、检验
均符合相关法规、药品注册要求和质量标准;
3.在产品放行前,质量受权人必须按照上述第 2 项的要求出
具产品放行审核记录,并纳入批记录。
第三节 培 训
...
低于 10 帕斯卡。必要时,相同洁净度级别的不同功能区域(操
作间)之间也应当保持适当的压差梯度。
...
够防止微生物的滋生。纯化水可采用循环,注射用水可采用 70°C
以上保温循环。
...
环境或设备控制视作中间控制的一部分。
第三百一十三条 本规范自 2011 年 3 月 1 日起施行。按照
